export async function onRequest(context) {
      const data = {
        '当前环境为：': process.env.ENVSCOPE || '未设置',
        '所属分支为：': process.env.BRANCH || '未设置',
        TEST: process.env.TEST || '未设置',
        NAME: process.env.NAME || '未设置',
        ALL: process.env.ALL || '未设置',
      }
      const html = `
<!DOCTYPE html>
<html>
